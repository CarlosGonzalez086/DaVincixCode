...
const Home = () => {
  return (
    <div className="home-bg p-2">
      <h1 className="alata-bold text-center home-title animate__animated animate__fadeInDown">
        Da VincixCode
      </h1>
      <div className="d-flex justify-content-center align-items-center gap-5 mt-5 p-3">
        <div className="home-content-container d-flex justify-content-center align-items-center gap-5 p-3">
          <div className="home-text-section text-center animate__animated animate__fadeInLeft">
            ...
            <h2 className="alata-small mt-4 home-main-subheading">
              ...
              tu negocio en un líder de vanguardia. <br /> Bienvenido a un mundo en el
